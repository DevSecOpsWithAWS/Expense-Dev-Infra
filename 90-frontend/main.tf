...
#stopping the frontend instance
...
#creating ami from the frontend instance
...
#deleting the frontend instance
...
resource "aws_autoscaling_group" "frontend" {
  ...
  vpc_zone_identifier       = local.public_subnet_idss
...
#creating listener rule for frontend
